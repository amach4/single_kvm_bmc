...
HORIZON_CONFIG['help_url'] = "https://docs.hpcloud.com/#4.x/helion/index.html"
...
HELION_EXTERNAL_SSL_CACERT = "{{ external_cacert_filename }}"
...
SITE_BRANDING = 'HPE Helion OpenStack'
